...
export default async function handler(request, response) {
  ...
  try {
    ...
    const schema = {
      ...
      required: ['symbol', 'side', 'currency', 'price', 'shares', 'stockValue', 'commission', 'vat', 'fee', 'date', 'confidence', 'notes'],
      propertyOrdering: ['symbol', 'side', 'currency', 'price', 'shares', 'stockValue', 'commission', 'vat', 'fee', 'date', 'confidence', 'notes'],
    };
